...
import SliderThumb from "../../SliderThumb"; // plasmic-import: t-ljPKhcD3sQ/component
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lkSmn)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__lln9Y)}>
        <div
