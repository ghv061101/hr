...
import Label from "../../Label"; // plasmic-import: OuIgegCwXW_8/component
import TextInput2 from "../../TextInput2"; // plasmic-import: gDX33FHd4CfM/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: VEKCyCToWA6V/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: s7zZYKkMpg7D/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__aMfYm, {
          [sty.freeBoxiconEnd__aMfYmo9R2]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__aMfYmcVv6I]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__aMfYmAvCfE]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__wzc5, {
            [sty.freeBoxiconStart__wzc5CVv6I]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__wzc5AvCfE]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__eUncn)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ltRsD, {
            [sty.freeBoxiconEnd__ltRsDo9R2]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__ltRsDcVv6I]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__eVrvw)}
                role={"img"}
              />
            ),
